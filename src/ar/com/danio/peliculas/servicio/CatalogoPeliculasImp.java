...
import ar.com.danio.peliculas.datos.AccesoDatosImp;
import ar.com.danio.peliculas.datos.IAccesoDatos;
...
public class CatalogoPeliculasImp implements ICatalogoPeliculas {
    ...
    public void buscarPelicula(String buscar) {
        ...
        try {
            ...
            System.out.println("Error acceso datos en buscarPelicula()");
            ex.printStackTrace(System.out);
        }
